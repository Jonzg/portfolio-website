            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-12 leading-relaxed max-w-3xl mx-auto">
                        Interested in data science collaboration or have a project in mind? 
                        Let's discuss how we can work together to turn your data challenges into opportunities.
                    </p>
                    ...
                    <div className="inline-flex items-center space-x-2 text-gray-600 text-lg bg-white px-6 py-3 rounded-full shadow-sm">
                        ...
                        <span>Based in Spain · Available for Remote Work & Collaboration</span>
                    </div>
                </div>
            </div>
        </section>
