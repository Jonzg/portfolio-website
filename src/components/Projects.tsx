...
interface Project {
    ...
    technologies: string[];
    githubLink: string;
    type: 'machine-learning' | 'data-analysis' | 'visualization';
    imageUrl?: string;
}
...
const projects: Project[] = [
    {
        ...
        description: 'Developed a deep learning model for time series forecasting using LSTM networks, achieving 95% accuracy in predicting market trends.',
    ...
    },
    {
        ...
        description: 'Interactive dashboard for visualizing complex datasets, featuring real-time updates and customizable charts.',
    ...
    },
    {
        ...
        description: 'End-to-end ML pipeline for predictive analytics, including data preprocessing, model training, and API deployment.',
